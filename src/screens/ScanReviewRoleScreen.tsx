...
export function ScanReviewRoleScreen({ navigation }: Props) {
  ...
  async function onContinue() {
    ...
    setPendingScanInput(buildScanInput(form!, role));
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.content}>
        <Title>Role match found</Title>
        <Subtitle>We identified a strong match for your current role.</Subtitle>

        <Card>
          <View style={styles.matchBadge}>
            <Text style={styles.matchBadgeText}>{qualityLabel}</Text>
          </View>
          <Text style={styles.label}>Role analyzed</Text>
