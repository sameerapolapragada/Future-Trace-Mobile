...
export function matchArchetype(role: string): RoleArchetype {
...
export function getArchetypeExposureLevel(role: string): AIExposureLevel {
  return matchArchetype(role).exposure;
}
...
export function transitionGapScore(fromRole: string, toRole: string): number {
