        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: "scan/review-role", lazy: lazyPage(() => import("./pages/ScanReviewRolePage")), handle: withNav },
              { path: "scan/role-confirm", lazy: lazyPage(() => import("./pages/ScanRoleConfirmPage")), handle: withNav },
              { path: "scan/role-needs-info", lazy: lazyPage(() => import("./pages/ScanRoleNeedsInfoPage")), handle: withNav },
              { path: "admin/unknown-roles", lazy: lazyPage(() => import("./pages/AdminUnknownRolesPage")) },
